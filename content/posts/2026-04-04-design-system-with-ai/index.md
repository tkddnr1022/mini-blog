...
### Figma API를 활용할 수는 없었나?

![](images/figma_api.png)
...
그리고 가장 중요한 원칙은 **SSOT**입니다. `Figma Design → CSS 토큰 → 컴포넌트 스타일`로 이어지는 흐름이 한 번이라도 생략되면 그 순간부터 동기화가 무너지고, 에이전트는 모든 것을 스스로 판단하게 됩니다.
